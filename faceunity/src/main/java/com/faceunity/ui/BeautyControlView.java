...
public class BeautyControlView extends FrameLayout {
    ...
    public void setOnFUControlListener(@NonNull OnFUControlListener onFUControlListener) {
        ...
        mEffectRecyclerAdapter.setOnFUControlListener(onFUControlListener);
    }
    ...
    private void initViewEffectRecycler() {
        ...
        mEffectRecyclerView.setAdapter(mEffectRecyclerAdapter = new EffectRecyclerAdapter(mContext));
