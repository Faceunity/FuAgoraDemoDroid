...
public class LiveRoomActivity extends BaseActivity implements AGEventHandler {
    ...
    private void initFURenderer() {
        mFURenderer = new FURenderer
                ...
                .build();
        BeautyControlView beautyControlView = findViewById(R.id.beauty_control_view);
...
//            surfaceV.setZOrderMediaOverlay(true);
            ...
            mFuTextureCamera = new FuTextureCamera(this, 640, 480);
            ...
            mUidsList.put(0, agoraSurfaceView); // get first surface view
