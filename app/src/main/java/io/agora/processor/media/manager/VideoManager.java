...
import io.agora.processor.video.renderer.RenderWithGlSurfaceView;
import io.agora.processor.video.renderer.RenderWithSurfaceView;
...
public class VideoManager {
    ...
    public boolean setRenderView(SurfaceView view) {
        ...
        renderView = view;
        if (mVideoRender == null) {
            mVideoRender = new RenderWithSurfaceView(null, mVideoCaptureConfigInfo);
        }
    ...
    public boolean setRenderView(GLSurfaceView view) {
        ...
        renderView = view;
        if (mVideoRender == null) {
            mVideoRender = new RenderWithGlSurfaceView(mVideoCaptureConfigInfo);
        }
        if (!mVideoRender.setRenderView(renderView)) {
            mNeedsPreview = false;
            LogUtil.w("set view error");
