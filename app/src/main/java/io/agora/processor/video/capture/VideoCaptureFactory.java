...
public class VideoCaptureFactory {
    ...
    // Factory methods.
    public static BaseVideoCapture createVideoCapture(Context context, VideoCaptureConfigInfo videoCaptureConfigInfo) {
//        if (isLReleaseOrLater() && !isLegacyDevice(context)) {
//            return new VideoCaptureCamera2(context, videoCaptureConfigInfo);
//        } else {
        return new VideoCaptureCamera(context, videoCaptureConfigInfo);
//        }
    }
}
